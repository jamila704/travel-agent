...
git clone https://github.com/TON\_USERNAME/travel-agent.git
...
| 1 | `python budget\_mcp\_server.py` |

| 2 | `python weather\_mcp\_server.py` |

| 3 | `python currency\_mcp\_server.py` |

| 4 | `python search\_mcp\_server.py` |

| 5 | `python calculator\_mcp\_server.py` |
